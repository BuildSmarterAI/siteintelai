...
import { Loader2, CheckCircle2, AlertCircle, Search, FileText, MapPin, User, Ruler } from 'lucide-react';
import { Card, CardContent } from '@/components/ui/card';
import { Badge } from '@/components/ui/badge';
import { Progress } from '@/components/ui/progress';
import type { SurveyMatchStatus, SurveyMatchCandidate, MatchReasonCode } from '@/types/surveyAutoMatch';
  ...
  return (
    <Card className={`border-l-4 ${
      ...
      <CardContent className="py-3 space-y-3">
        ...
        {extraction && (extraction.apn_extracted || extraction.address_extracted) && status !== "matched" && (
