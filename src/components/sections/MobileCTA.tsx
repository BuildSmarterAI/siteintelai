...
export const MobileCTA = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 bg-maxx-red p-4 shadow-lg border-t border-maxx-red/20 md:hidden">
      <div className="flex items-center justify-between space-x-4">
        ...
        <Button 
          variant="outline"
          className="bg-maxx-red-foreground text-maxx-red border-maxx-red-foreground hover:bg-maxx-red-foreground/90 font-cta font-semibold px-6"
