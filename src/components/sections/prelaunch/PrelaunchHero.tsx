  ...
  return (
    <section className="relative min-h-[90vh] flex items-center overflow-hidden bg-background">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-24 py-16 w-full">
        ...
        <div className="absolute right-0 md:-right-32 lg:-right-48 top-1/2 -translate-y-1/2 w-[400px] h-[400px] md:w-[600px] md:h-[600px] lg:w-[800px] lg:h-[800px] opacity-30 pointer-events-none z-0">
          <Globe />
        </div>
