      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 md:px-12 py-8 md:py-0 text-center">
        ...
        >
          ...
          <motion.div 
            ...
            className="inline-flex items-center gap-2 px-4 py-2 bg-primary/10 border border-primary/30 rounded-full mb-5"
          >
          ...
          <motion.h1 
            ...
            className="font-heading text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight leading-[1.15] md:leading-[1.1] max-w-[90%] md:max-w-none drop-shadow-[0_2px_4px_rgba(0,0,0,0.5)]"
          >
          ...
          >
            <Button 
              ...
              className="bg-[#FF7A00] hover:bg-[#FF9240] text-white font-semibold px-8 min-h-[54px] py-4 text-lg rounded-xl shadow-lg shadow-[#FF7A00]/25 transition-all duration-300 hover:shadow-xl hover:shadow-[#FF7A00]/30 hover:scale-[1.02] active:scale-[0.98]"
            >
          ...
          <motion.p 
            variants={itemVariants}
            className="mt-8 text-base md:text-lg text-white leading-[1.4] max-w-[85%] md:max-w-2xl drop-shadow-[0_1px_2px_rgba(0,0,0,0.4)]"
          >
          ...
          <motion.p 
            variants={itemVariants}
            className="hidden md:block mt-4 text-base text-white/80 max-w-3xl leading-relaxed drop-shadow-[0_1px_2px_rgba(0,0,0,0.3)]"
          >
          ...
          <motion.p 
            variants={itemVariants}
            className="hidden md:flex text-xs text-white/60 items-center justify-center gap-2 mt-6"
          >
