...
export function MapLibreCanvas({
  ...
  // DISABLED: Vector tile click handlers - now handled by useFallbackParcels
  // The fallback hook (useFallbackParcels) manages all parcel click interactions
  // This avoids conflicts between multiple click handlers and "No parcel found" messages
  // TODO: Re-enable when SiteIntel vector tiles are ready on CloudFront CDN
  /*
  useEffect(() => {
    // Vector tile parcel click handler - DISABLED
    // useFallbackParcels now handles all parcel clicks via GeoJSON layers
  }, [mapLoaded, showParcels]);
  */
