...
export const COUNTY_TILE_SOURCES: CountyTileSource[] = [
  ...
  },
  {
    ...
    mapServerUrl: 'https://taxmaps.traviscountytx.gov/arcgis/rest/services/Parcels/MapServer',
    featureServerUrl: 'https://taxmaps.traviscountytx.gov/arcgis/rest/services/Parcels/MapServer/0',
    layerId: 0,
    bounds: [-98.2, 30.0, -97.3, 30.6],
    minZoom: 13,
    maxZoom: 20,
    attribution: 'Travis County Tax Office',
    isActive: true,
  },
  {
    id: 'dallas',
  ...
  },
  {
    ...
    mapServerUrl: 'https://mapit.tarrantcounty.com/arcgis/rest/services/Tax/TCProperty/MapServer',
    featureServerUrl: 'https://mapit.tarrantcounty.com/arcgis/rest/services/Tax/TCProperty/MapServer/0',
    layerId: 0,
    bounds: [-97.6, 32.5, -96.9, 33.0],
    minZoom: 13,
    maxZoom: 20,
    attribution: 'Tarrant County Tax Assessor',
    isActive: true,
  },
  {
    id: 'bexar',
    ...
    mapServerUrl: 'https://maps.bexar.org/arcgis/rest/services/Parcels/MapServer',
    featureServerUrl: 'https://maps.bexar.org/arcgis/rest/services/Parcels/MapServer/0',
    layerId: 0,
    bounds: [-98.8, 29.1, -98.2, 29.8],
    minZoom: 13,
    maxZoom: 20,
    attribution: 'Bexar County',
    isActive: true,
  },
  {
    id: 'williamson',
    ...
    mapServerUrl: 'https://gis.wilco.org/arcgis/rest/services/public/county_wcad_parcels/MapServer',
    featureServerUrl: 'https://gis.wilco.org/arcgis/rest/services/public/county_wcad_parcels/MapServer/0',
    layerId: 0,
